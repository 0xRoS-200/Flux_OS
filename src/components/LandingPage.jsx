...
import { ArrowRight, Download, Image as ImageIcon, WalletCards } from "lucide-react";
    ...
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-4 sm:p-6 bg-[#fdfcfd] dark:bg-[#0e0c08] selection:bg-sky-500/20">
      ...
      <div className="relative z-10 w-full max-w-lg flex flex-col gap-6 sm:gap-8 items-center">
        ...
        <div className="w-full p-6 sm:p-10 md:p-12 rounded-2xl bg-white/70 dark:bg-stone-950/80 border border-white dark:border-stone-800/20 backdrop-blur-[120px] shadow-[0_40px_100px_rgba(0,0,0,0.12)] dark:shadow-[0_40px_100px_rgba(0,0,0,0.6)] overflow-hidden transition-all relative ring-1 ring-black/5">
          ...
          <form onSubmit={handleStart} className="flex flex-col gap-6 sm:gap-8">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-3">
                  <input type="text" value={photo} onChange={e => setPhoto(e.target.value)} className="flex-1 p-3 sm:p-4 bg-stone-50/30 dark:bg-stone-900/40 border border-stone-200/50 dark:border-stone-800/50 rounded-xl focus:outline-none focus:border-orange-500/50 text-stone-800 dark:text-white truncate transition-all text-sm font-medium placeholder-stone-300 dark:placeholder-stone-700 shadow-sm" placeholder="Image URL..." />
                  <label className="cursor-pointer p-3 sm:p-4 bg-stone-100/60 dark:bg-stone-800/60 rounded-xl border border-stone-200/50 dark:border-stone-800/50 transition-all flex items-center justify-center hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 shadow-sm shrink-0">
            ...
            <button type="submit" className="w-full mt-2 flex items-center justify-center gap-3 p-4 sm:p-5 bg-stone-900 dark:bg-orange-600 text-white font-bold text-sm rounded-xl active:scale-[0.98] transition-all hover:shadow-2xl hover:shadow-orange-500/30 tracking-tight">
